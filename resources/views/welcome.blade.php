...
<head>
    ...
    <link href="{{ 'soon/img/apple-touch-icon.png' }}" rel="apple-touch-icon">

    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Lato:300,400,700,900" rel="stylesheet">

    <!-- Bootstrap CSS File -->
    <link href="{{ asset('soon/lib/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Libraries CSS Files -->
    <link href="{{ asset('soon/lib/ionicons/css/ionicons.min.css') }}" rel="stylesheet">
...
<body>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="countdown-header">
                        <div class="countdown" data-date="2022/5/15"></div>
                    </div>
                </div>
            </div>
            <!--/row-->
    ...
    {{-- <div class="container ptb">
        <div class="row">
            <div class="col-md-6">
                ...
                <BR />
                <h4>SYSTEM VISITOR MANAGEMENT SYSTEM.</h4>
            ...
            <!--/col-md-6-->
            <div class="col-md-6">
                <img src="{{ asset('soon/img/browser.png') }}" class="aligncenter" width="350">
            </div>
            <!--/col-md-6 -->
        </div>
        <!--/row-->
        ...
        <div class="container">
            <div class="row centered">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <form role="form" action="{{ route('subscribe.store') }}" method="post" enctype="plain">
                        @csrf
    ...
    <div id="copyrights">
        <div class="container">
            <p>
                &copy; Copyrights <strong>Rafiki Technologies</strong>. All Rights Reserved
            </p>
            <div class="credits">
                <!--
    ...
    <script src="{{ asset('soon/lib/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('soon/lib/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('soon/lib/php-mail-form/validate.js') }}"></script>
    <script src="{{ asset('soon/lib/countdown/jquery.plugin.min.js') }}"></script>
    <script src="{{ asset('soon/lib/countdown/jquery.countdown.min.js') }}"></script>
